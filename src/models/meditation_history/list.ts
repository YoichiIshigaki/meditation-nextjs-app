import { getDocs, query, orderBy, limit, type QueryConstraint, where } from 'firebase/firestore';
...
export const list = async (options?: ListOptions): Promise<MeditationHistory[]> => {
