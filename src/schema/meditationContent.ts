...
export type MeditationContentUpdateSchema = z.infer<
  typeof meditationContentUpdateSchema
>;
...
export const createMeditationContentFormSchema = (t: TranslationFunction) =>
  z.object({
    ...
    image_url: z
      .string()
      .url(t("admin:validation_url_invalid"))
      .optional()
      .or(z.literal("")),
    audio_url: z
      .string()
...
export type MeditationContentFormSchema = z.infer<
  ReturnType<typeof createMeditationContentFormSchema>
>;
