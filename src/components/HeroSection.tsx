...
export default function HeroSection() {
  return (
    ...
    >
      <div className="text-[22px] font-light mb-5" style={{ textShadow: '1px 1px 3px rgba(0,0,0,0.5)' }}>
        木々は春を追いかけずに待つ。その時が来るのを知っているから。
      </div>
      <button className="bg-white text-gray-800 rounded-full py-2 px-4 text-sm border-none cursor-pointer flex items-center">
        <span>詳しく見る</span>
      </button>
    </div>
  );
